  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <span
          className={`px-3 py-1 rounded-md text-md font-semibold ${
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        text={event.modality === "online" ? event.link || "Enlace no especificado" : event.location || "Ubicación no especificada"}
          />
        ...
        label="Capacidad"
        text={`${event.attendees?.length || 0} / ${event.capacity}`}
          />
        </div>
      </div>
    </div>
